...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerAddress1 == msg.sender || ownerAddress2 == msg.sender, "Sender Must be the owner of one of the token you provide");
    ...
    function transferStar(address newOwner, uint256 tokenId) public {
        //1. Check if the sender is the ownerOf(tokenId)
         address ownerAddress = ownerOf(tokenId);
         require(ownerAddress == msg.sender, "Sender Must be the owner of token");
        //2. Use the transferFrom(from, to, tokenId); function to transfer the Star
         _transferFrom(ownerAddress, newOwner, tokenId);
    }
